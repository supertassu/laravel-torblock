...
interface TorExitNodeService
{
    /**
     * Check if the specified IP address is a Tor exit node.
     * @param string $ip
     * @return bool
     */
    ...
    /**
     * Create an exception stating that the specified IP address is a Tor exit node.
     * @param string $ip
     * @return TorBlocked
     */
